...
All the environments are registered in the `g1_button_project` extension. They start
...
import g1_button_project.tasks  # noqa: F401


def main():
    """Print all environments registered in `g1_button_project` extension."""
